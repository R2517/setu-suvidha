...
class DashboardController extends Controller
{
    ...
    private function getServiceCards(): array
    {
        return [
            ...
            ['id' => 'docslip', 'title' => 'कागदपत्र पावती (DocSlip)', 'icon' => 'clipboard-list', 'iconBg' => 'linear-gradient(135deg, #F3E8FF, #E9D5FF)', 'iconColor' => '#7C3AED', 'path' => '/docslip', 'ready' => true, 'badge' => 'NEW', 'badgeType' => 'new'],
            ...
            ['id' => 'bond-format', 'title' => 'प्रतिज्ञापत्र व शपथपत्र (Affidavits & Shapathpatra)', 'icon' => 'file-text', 'iconBg' => 'linear-gradient(135deg, #FFF7ED, #FED7AA)', 'iconColor' => '#EA580C', 'path' => '/bond-formats', 'ready' => true, 'badge' => 'NEW', 'badgeType' => 'new'],
