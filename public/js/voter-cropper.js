document.addEventListener('alpine:init', () => {
    Alpine.data('voterCropper', () => ({
        ...
        async loadAndCropPdf(arrayBuffer, password) {
            ...
            // --- CROP LOGIC FOR voter ---
            // The e-voter PDF has the front card in the top half of the bottom section
            // and the back card in the bottom half.
            // These coordinates are approximate and based on standard e-voter format.
        ...
        extractCard(sourceCanvas, targetCanvas, isFront) {
            ...
            if (window.CropSettings && window.CropSettings['voter_front']) {
                frontSettings = window.CropSettings['voter_front'];
            }
            if (window.CropSettings && window.CropSettings['voter_back']) {
                backSettings = window.CropSettings['voter_back'];
            }
        ...
        downloadImages() {
            ...
            link.download = 'voter_Card_Combined.png';
