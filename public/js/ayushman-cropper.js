document.addEventListener('alpine:init', () => {
    Alpine.data('ayushmanCropper', () => ({
        ...
        async loadAndCropPdf(arrayBuffer, password) {
            ...
            // --- CROP LOGIC FOR ayushman ---
            // The e-ayushman PDF has the front card in the top half of the bottom section
            // and the back card in the bottom half.
            // These coordinates are approximate and based on standard e-ayushman format.
        ...
        extractCard(sourceCanvas, targetCanvas, isFront) {
            ...
            if (window.CropSettings && window.CropSettings['ayushman_front']) {
                frontSettings = window.CropSettings['ayushman_front'];
            }
            if (window.CropSettings && window.CropSettings['ayushman_back']) {
                backSettings = window.CropSettings['ayushman_back'];
            }
        ...
        downloadImages() {
            ...
            link.download = 'ayushman_Card_Combined.png';
