document.addEventListener('alpine:init', () => {
    Alpine.data('eshramCropper', () => ({
        ...
        extractCard(sourceCanvas, targetCanvas, isFront) {
            ...
            if (window.CropSettings && window.CropSettings['eshram_front']) {
                frontSettings = window.CropSettings['eshram_front'];
            }
            if (window.CropSettings && window.CropSettings['eshram_back']) {
                backSettings = window.CropSettings['eshram_back'];
            }
        ...
        downloadImages() {
            ...
            link.download = 'E-Shram_Card_Combined.png';
