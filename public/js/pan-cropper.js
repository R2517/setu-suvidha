document.addEventListener('alpine:init', () => {
    Alpine.data('panCropper', () => ({
        ...
        extractCard(sourceCanvas, targetCanvas, isFront) {
            ...
            if (window.CropSettings && window.CropSettings['pan_front']) {
                frontSettings = window.CropSettings['pan_front'];
            }
            if (window.CropSettings && window.CropSettings['pan_back']) {
                backSettings = window.CropSettings['pan_back'];
            }
        ...
        downloadImages() {
            ...
            link.download = 'PAN_Card_Combined.png';
