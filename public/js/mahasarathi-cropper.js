document.addEventListener('alpine:init', () => {
    Alpine.data('mahasarathiCropper', () => ({
        isProcessing: false,
        ...
        extractCard(sourceCanvas, targetCanvas, isFront) {
            ...
            if (window.CropSettings && window.CropSettings['mahasarathi_front']) {
                frontSettings = window.CropSettings['mahasarathi_front'];
            }
            if (window.CropSettings && window.CropSettings['mahasarathi_back']) {
                backSettings = window.CropSettings['mahasarathi_back'];
            }
        ...
        downloadImages() {
            ...
            link.download = 'Mahasarathi_Card_Combined.png';
