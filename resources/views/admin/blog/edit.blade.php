        ...
        <div class="max-w-4xl mx-auto">
            <div class="mb-6">
                <h1 class="text-2xl font-black text-gray-900 dark:text-white flex items-center gap-2">
                    <i data-lucide="edit" class="w-6 h-6 text-amber-500 pointer-events-none"></i> Edit Blog Post
                </h1>
            ...
            <div class="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-2xl border-2 border-amber-300 dark:border-amber-700 p-6 mb-6">
                ...
                <div class="relative">
                    <textarea id="smartJsonInput" rows="12" class="w-full px-4 py-3 rounded-xl border-2 border-amber-200 dark:border-amber-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white font-mono text-xs focus:border-amber-500 focus:ring-2 focus:ring-amber-200 leading-5" placeholder='Paste your full JSON here...' oninput="liveValidate()">{{ json_encode($post->content_json, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES) }}</textarea>
            ...
            <form action="{{ route('admin.blog.update', $post->id) }}" method="POST" class="space-y-6" id="blogForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="title" id="fTitle" required value="{{ old('title', $post->title) }}" class="w-full px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white">
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="blog_category_id" id="fCategory" class="w-full px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
                                    ...
                                    <option value="{{ $cat->id }}" data-slug="{{ $cat->slug }}" {{ (old('blog_category_id', $post->blog_category_id) == $cat->id) ? 'selected' : '' }}>{{ $cat->name_en }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="tags_text" id="fTags" value="{{ old('tags_text', implode(', ', $post->tags->pluck('name_en')->toArray())) }}" class="w-full px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white" placeholder="tag1, tag2, tag3">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Excerpt</label>
                            <textarea name="excerpt" id="fExcerpt" rows="3" class="w-full px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white" placeholder="Short summary (150-160 characters ideal)">{{ old('excerpt', $post->excerpt) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6">
                    ...
                    <div>
                        <textarea name="content_json" id="fContentJson" required rows="10" class="w-full px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white font-mono text-xs" placeholder='Auto-filled from Smart Import above'>{{ old('content_json', json_encode($post->content_json, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES)) }}</textarea>
                ...
                <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="meta_title" id="fMetaTitle" maxlength="60" value="{{ old('meta_title', $post->meta_title) }}" class="w-full px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Meta Description (max 160 chars)</label>
                            <textarea name="meta_description" id="fMetaDesc" rows="2" maxlength="160" class="w-full px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">{{ old('meta_description', $post->meta_description) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="hidden" name="featured_image" id="fImage" value="{{ old('featured_image', $post->featured_image) }}">
                            <div id="imagePreview" class="{{ $post->featured_image ? '' : 'hidden' }} mt-3">
                                <img id="imagePreviewImg" src="{{ $post->featured_image ? asset($post->featured_image) : '' }}" alt="Preview" class="max-h-48 rounded-xl border border-gray-200 dark:border-gray-700">
                            </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="featured_image_alt" id="fImageAlt" value="{{ old('featured_image_alt', $post->featured_image_alt) }}" class="w-full px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800" placeholder="Descriptive alt text for SEO">
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3">
                    <button type="submit" class="px-6 py-3 bg-amber-500 text-white rounded-xl font-bold hover:bg-amber-600 transition flex items-center gap-2">
                        <i data-lucide="check" class="w-5 h-5 pointer-events-none"></i> Update Post
                    </button>
