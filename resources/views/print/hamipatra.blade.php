...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .oath-section { margin-top: 20px; text-align: justify; }
        .oath-section ol { padding-left: 25px; margin-top: 10px; }
        .oath-section ol li { margin-bottom: 8px; }
...
<body>
    ...
    <div class="a4-page">
        <h1>हमीपत्र</h1>
        <div class="subtitle">(Guarantee Bond / Disclaimer)</div>

        <div class="body-text">
            <p>मी खाली सही करणारा/करणारी <span class="field-underline">{{ $data['guarantor_name'] ?? $submission->applicant_name }}</span>
            वय <span class="field-underline">{{ $data['age'] ?? '____' }}</span> वर्षे,
            व्यवसाय <span class="field-underline">{{ $data['occupation'] ?? '____' }}</span>,
            रा. <span class="field-underline">{{ $data['address'] ?? '____' }}</span>
            </p>

            <p style="margin-top: 15px;">
                याद्वारे प्रतिज्ञापूर्वक लिहून देतो/देते की, श्री./श्रीमती <span class="field-underline">{{ $submission->applicant_name }}</span>
                यांच्या हमीदार म्हणून मी जबाबदार राहील.
            </p>
        </div>
        ...
        <div class="oath-section">
            ...
            <ol>
                ...
                <li>मी सदर व्यक्तीच्या सर्व कायदेशीर जबाबदाऱ्यांसाठी हमीदार म्हणून राहण्यास तयार आहे.</li>
                <li>जर सदर माहिती खोटी आढळली तर मी कायदेशीर कारवाईस पात्र राहील.</li>
                <li>हे हमीपत्र मी स्वखुशीने व कोणत्याही दबावाशिवाय लिहून देत आहे.</li>
            </ol>
        </div>
        ...
        <div class="signature-area">
            <div class="sig-box">
                <div class="sig-line">हमीदाराची सही<br><small>{{ $data['guarantor_name'] ?? '' }}</small></div>
            </div>
            <div class="sig-box">
                <div class="sig-line">अर्जदाराची सही<br><small>{{ $submission->applicant_name }}</small></div>
            </div>
        </div>
    </div>
</body>
