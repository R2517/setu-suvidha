...
@section('title', 'बँक लोन संमतीपत्र — SETU Suvidha')
    ...
    <div class="w-[360px] min-w-[360px] bg-[#f8fafc] overflow-y-auto flex flex-col border-r border-gray-200/60 z-10" id="leftPanel">
        ...
        <div class="flex items-center justify-between px-4 py-3 bg-white border-b border-gray-100 sticky top-0 z-20">
            <div class="flex items-center gap-2.5">
                ...
                <div>
                    <h2 class="text-sm font-bold text-gray-800 leading-tight">Bank Loan NOC</h2>
                    <p class="text-[10px] text-gray-400">संमतीपत्र</p>
                </div>
            </div>
        ...
        <div class="px-3 pb-4 space-y-2.5 mt-2.5">
            ...
            <div class="section-card">
                <div class="section-header"><span class="num">1</span><span class="title">प्रतिज्ञार्थी (मुख्य अर्जदार)</span></div>
                <div class="section-body space-y-2">
                    <div><label class="field-label">पूर्ण नाव</label><input type="text" id="inp_app_name" oninput="sync()" placeholder="उदा. रमेश मारोतराव पाटील" class="form-input"></div>
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <div><label class="field-label">धंदा</label><input type="text" id="inp_app_occ" oninput="sync()" placeholder="शेती" class="form-input"></div>
                    </div>
                    <div><label class="field-label">रा. (पूर्ण पत्ता)</label><textarea id="inp_app_addr" oninput="sync()" rows="2" placeholder="मु.पो. नांदगाव खंडेश्वर जि. अमरावती" class="form-textarea"></textarea></div>
                    <div><label class="field-label">दंडाधिकारी कार्यालय ठिकाण</label><input type="text" id="inp_magistrate" oninput="sync()" value="नांदगाव खंडेश्वर" class="form-input"></div>
                </div>
            </div>

            {{-- SEC 2: शेतीचे तपशील --}}
            <div class="section-card">
                <div class="section-header"><span class="num">2</span><span class="title">सामाईक शेतीचे तपशील</span></div>
                <div class="section-body space-y-2">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <div><label class="field-label">क्षेत्रफळ (हे.आर)</label><input type="text" id="inp_farm_area" oninput="sync()" placeholder="१.२० हे." class="form-input"></div>
                    </div>
                </div>
            </div>
            ...
            {{-- SEC 3: लोन लाभार्थी --}}
            <div class="section-card">
                <div class="section-header"><span class="num">3</span><span class="title">लोन घेणाऱ्या व्यक्तीचे नाव</span></div>
                <div class="section-body space-y-2">
                    <div><label class="field-label">पूर्ण नाव (श्री/श्रीमती/सौ)</label><input type="text" id="inp_ben_name" oninput="sync()" placeholder="रमेश मारोतराव पाटील" class="form-input"></div>
                </div>
            </div>

            {{-- SEC 4: संमती देणारे (Co-owners) --}}
            <div class="section-card">
                <div class="section-header"><span class="num">4</span><span class="title">संमती देणारे (इतर हिस्सेदार)</span></div>
                <div class="section-body space-y-2">
                    <div><label class="field-label">१. नाव</label><input type="text" id="inp_co1" oninput="sync()" placeholder="सुरेश मारोतराव पाटील" class="form-input"></div>
                    <div><label class="field-label">२. नाव</label><input type="text" id="inp_co2" oninput="sync()" placeholder="महेश मारोतराव पाटील" class="form-input"></div>
                    <div><label class="field-label">३. नाव (असल्यास)</label><input type="text" id="inp_co3" oninput="sync()" placeholder="" class="form-input"></div>
                </div>
            </div>

            {{-- SEC 5: ठिकाण व दिनांक --}}
            <div class="section-card">
                <div class="section-header"><span class="num">5</span><span class="title">ठिकाण व दिनांक</span></div>
                <div class="section-body space-y-2">
                    <div><label class="field-label">ठिकाण (स्थळ)</label><input type="text" id="inp_place" oninput="sync()" placeholder="नांदगाव खंडेश्वर" class="form-input"></div>
    ...
    <div class="flex-1 overflow-y-auto bg-[#555] pt-0 pb-8 px-4 relative preview-area">
        ...
        <div id="page1" class="bond-page relative w-[794px] mx-auto bg-white shadow-2xl mb-6"
            ...
            <div id="page1_content" class="bond-content py-4" contenteditable="true" spellcheck="false" style="padding-left:40px;padding-right:40px;">
                ...
                <div class="mb-4">
                    <p class="font-bold mb-3">विद्यमान कार्यकारी दंडाधिकारी, <span id="out_magistrate" class="out-field filled">नांदगाव खंडेश्वर</span></p>
                ...
                {{-- Subject --}}
                <p class="font-bold text-[1.15rem] mb-3 text-center underline">विषय :- बँक चे लोन देण्या बाबत संमतीपत्र</p>

                <p class="mb-2 font-bold">महोदय,</p>
                
                {{-- Body Paragraph 1 --}}
                <p class="leading-[2.2] text-justify mb-4" style="text-indent: 40px;">
                    मी सत्य प्रतिज्ञेवर लिहून देतो/देते की, आम्ही खालील सही करणार संमती पत्र लिहून देतो की, आमची खालील वर्णनाची सामाईक शेती आहे.
                </p>
            </div>
        </div>
        ...
        <div id="page2" class="bond-page relative w-[794px] mx-auto bg-white shadow-2xl mb-6"
            ...
            <div id="page2_content" class="bond-content py-4" contenteditable="true" spellcheck="false" style="padding-left:40px;padding-right:40px;">
                ...
                <table class="farm-table font-semibold">
                    <thead>
                        <tr class="bg-gray-100">
                            <th style="width:40%;">मौजा</th>
                            <th style="width:30%;">स.नं</th>
                            <th style="width:30%;">क्षेत्रफळ हे.आर</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td><span id="out_farm_mauza" class="out-field empty" style="font-weight:normal;">&nbsp;</span></td>
                            <td><span id="out_farm_survey" class="out-field empty" style="font-weight:normal;">&nbsp;</span></td>
                            <td><span id="out_farm_area" class="out-field empty" style="font-weight:normal;">&nbsp;</span></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <p class="leading-[2.2] text-justify mb-6">
                    वरील शेता करिता बँकेचे लोन करिता संमती देत आहे. आमच्या सर्वांच्या वतीने 
                    <strong>श्री/श्रीमती/सौ <span id="out_ben_name" class="out-field empty font-bold text-lg border-b border-dashed border-gray-400">&nbsp;</span></strong> यांना 
                    देण्यास विनाअट संमती आहे.
                </p>

                {{-- Signature Block 1 --}}
                <div class="sig-block mt-4 mb-6 text-[1em] font-bold">
                    <div>
                ...
                {{-- Consenting Members --}}
                <p class="leading-[2] text-justify mb-4">
                    तरी बँक चे लोन संमती वरील प्रतिज्ञार्थीच्या नावानी देण्यास आम्ही संमती देत आहे व खालील सही करत आहे.
                </p>

                <table style="width:100%; margin-bottom: 20px; line-height:2.5;">
                    <tr>
                        <th style="width:70%; text-align:left;">नाव</th>
                        <th style="width:30%; text-align:center;">सही</th>
                    </tr>
                    <tr>
                        <td>१. <span id="out_co1" class="out-field empty">&nbsp;</span></td>
                        <td style="border-bottom:1px dashed #666;"></td>
                    </tr>
                    <tr>
                        <td>२. <span id="out_co2" class="out-field empty">&nbsp;</span></td>
                        <td style="border-bottom:1px dashed #666;"></td>
                    </tr>
                    <tr id="co3_row" style="display:none;">
                        <td>३. <span id="out_co3" class="out-field empty">&nbsp;</span></td>
                        <td style="border-bottom:1px dashed #666;"></td>
                    </tr>
                </table>
                ...
                {{-- Verification --}}
                <p class="font-bold text-center text-lg mb-2 underline">सत्यापन</p>
                <p class="leading-[2] text-justify mb-6">
                    आम्ही वर दिलेली माहिती संपूर्णपणे सत्य व खरी असून, ती असत्य निघाल्यास त्यास मी भा.दं.वि.कलम १९९, १९३(२), २०० नुसार कारवाईस पात्र राहील याची मला जाणीव आहे.
                </p>

                {{-- Signature Block 2 --}}
                <div class="sig-block mt-4 text-[1em] font-bold">
                    <div>
                        <p class="mb-2">ठिकाण:- <span id="out_place2" class="out-field empty" style="font-weight:normal;">&nbsp;</span></p>
                        <p class="mb-0">दि. :- <span id="out_date2" class="out-field empty" style="font-weight:normal;">&nbsp;</span></p>
                    </div>
                    <div class="text-center">
                        <p class="mb-14 text-transparent select-none">.</p>
                        <p class="mb-0 border-t border-gray-600 pt-1 inline-block px-4">प्रतिज्ञार्थीची सही</p>
...
<div id="guideModal" class="fixed inset-0 bg-black/60 z-50 items-center justify-center hidden" onclick="closeGuide(event)">
    <div class="bg-white rounded-2xl shadow-2xl max-w-lg w-full mx-4 p-6">
        ...
        <div class="text-sm text-gray-700 space-y-3">
            <div><p class="font-bold text-gray-800 mb-1">1. तपशील भरा:</p><p>डावीकडे प्रतिज्ञार्थी, शेती व लोन लाभार्थीचे तपशील भरा.</p></div>
            <div><p class="font-bold text-gray-800 mb-1">2. संमती देणारे (वारस):</p><p>जेवढी नावे टाकाल तेवढीच प्रिंट होतील (कमीत कमी १, जास्तीत जास्त ३).</p></div>
...
function sync(){
    ...
    // Dynamic row hiding for Co-owners
    var co3 = document.getElementById('inp_co3').value.trim();
    document.getElementById('co3_row').style.display = co3 ? 'table-row' : 'none';
}
...
function payAndPrint(){
    ...
    if(!confirm('Confirm Payment of ₹{{ number_format($format->fee, 0) }} for बँक लोन संमतीपत्र?'))return;
    ...
    fetch('{{ route("bonds.deductFee") }}',{method:'POST',headers:{'Content-Type':'application/json','X-CSRF-TOKEN':document.querySelector('meta[name="csrf-token"]').content,'Accept':'application/json'},body:JSON.stringify({slug:'bank-loan-noc'})})
