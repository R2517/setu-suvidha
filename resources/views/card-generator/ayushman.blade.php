@extends('layouts.app')
@section('title', 'Free Ayushman Bharat Card Crop & Print Online | SETU Suvidha')
@section('description', 'Crop your e-Ayushman Bharat PDF to perfect CR-80 card size and print instantly. 100% Free, private, no upload needed. Best for VLEs and CSCs.')
@section('keywords', 'free Ayushman Bharat crop, Ayushman Bharat print online, csc Ayushman Bharat crop, pvc card print, setu suvidha')
...
<div class="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-6 no-print">
    ...
    {{-- Main Tool Column --}}
    <div class="lg:col-span-8 w-full space-y-6" x-data="Ayushman BharatCropper()">
    ...
    <div class="flex items-center gap-3 border-b border-gray-200 dark:border-gray-800 pb-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                ...
                Crop Ayushman Bharat Card Online
            </h1>
            <p class="text-sm text-gray-500">Auto-crop and print perfect CR-80 sized Ayushman Bharat cards from PDF.</p>
        </div>
    </div>
    ...
    <div x-show="!hasProcessedFile && !isProcessing" 
        ...
        <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-1">Upload or Drop Ayushman Bharat PDF here</h3>
...
<script src="{{ asset('js/Ayushman Bharat-cropper.js') }}"></script>
@endpush
