@extends('layouts.app')
@section('title', 'Free PAN Card Crop & Print Online | SETU Suvidha')
@section('description', 'Crop your e-PAN card PDF to standard CR-80 card size for printing. 100% free, browser-based, no sign-up required. Perfect for CSC and VLEs.')
@section('keywords', 'free pan card crop, e-pan print online, csc pan crop, nsdl pan print, uti pan crop, setu suvidha')
...
<div class="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-6 no-print">
    ...
    {{-- Main Tool Column --}}
    <div class="lg:col-span-8 w-full space-y-6" x-data="panCropper()">
    ...
    <div class="flex items-center gap-3 border-b border-gray-200 dark:border-gray-800 pb-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                ...
                Crop PAN Card Online
            </h1>
            <p class="text-sm text-gray-500">Auto-crop and print perfect CR-80 sized PAN cards from PDF.</p>
        </div>
    </div>
    ...
    <div x-show="!hasProcessedFile && !isProcessing" 
        ...
        <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-1">Upload or Drop PAN Card PDF here</h3>
...
<script src="{{ asset('js/pan-cropper.js') }}"></script>
@endpush
