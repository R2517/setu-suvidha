@extends('layouts.app')
@section('title', 'Free ABHA Card Crop & Print Online | SETU Suvidha')
@section('description', 'Crop your e-ABHA Health Card PDF to standard CR-80 card size for printing. 100% free, browser-based, no sign-up required. Best for CSC centers.')
@section('keywords', 'free abha card crop, abha health card print online, csc abha crop, ayushman bharat card print, setu suvidha')
...
<div class="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-6 no-print">
    ...
    {{-- Main Tool Column --}}
    <div class="lg:col-span-8 w-full space-y-6" x-data="abhaCropper()">
    ...
    <div class="flex items-center gap-3 border-b border-gray-200 dark:border-gray-800 pb-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                ...
                Crop ABHA Card Online
            </h1>
            <p class="text-sm text-gray-500">Auto-crop and print perfect CR-80 sized ABHA Cards from PDF.</p>
        </div>
    </div>
    ...
    <div x-show="!hasProcessedFile && !isProcessing" 
        ...
        <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-1">Upload or Drop ABHA Card PDF here</h3>
...
<script src="{{ asset('js/abha-cropper.js') }}"></script>
@endpush
